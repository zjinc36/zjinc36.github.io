...
- [大模型与MCP](2025/20251013-大模型与MCP.md)
- [AIAgent核心架构与典型案例](2026/20260228-AIAgent核心架构与典型案例.md)
...
- [禁止root账号直接登录](2021/20210830-禁止root账号直接登录.md)
- [配置ssh使用证书访问服务器](2021/20210626-配置ssh使用证书访问服务器.md)
...
- [将相关下载命令重命名](2021/20210830-将相关下载命令重命名.md)
- [安装k8s和harbor](2021/20210506-安装k8s和harbor.md)
- [centos7安装docker](2021/20210506-centos7安装docker.md)
...
- [CSS_10_高度塌陷与BFC](2022/20220429-CSS_10_高度塌陷与BFC.md)
- [CSS_11_定位](2022/20220429-CSS_11_定位.md)
- [CSS_12_字体](2022/20220504-CSS_12_字体.md)
...
- [Eclipse中一键删除类中无用的包](2017/20170409-Eclipse中一键删除类中无用的包.md)
- [调整eclipse左边包的显示方式](2017/20170810-调整eclipse左边包的显示方式.md)
- [eclipse中如何查询一个类的继承关系](2017/20171005-eclipse中如何查询一个类的继承关系.md)
- [Eclipse配置Tomcat](2019/20190624-Eclipse配置Tomcat.md)
- [eclipse中导入dtd和xsd使得xml文件能自动提示](2019/20190703-eclipse中导入dtd和xsd使得xml文件能自动提示.md)
- [xxx-is-a-raw-type-References-to-generic-type-xxx-y-should-be-parameterized](2019/20190709-xxx-is-a-raw-type-References-to-generic-type-xxx-y-should-be-parameterized.md)
...
- [分布式系统核心定理](2026/20260122-分布式系统核心定理.md)
- [分布式理论之CAP定理](2022/20220617-分布式理论之CAP定理.md)
- [分布式理论之BASE理论](2022/20220617-分布式理论之BASE理论.md)
- [分布式理论之2PC协议](2022/20220617-分布式理论之2PC协议.md)
...
- [Git三路合并](2020/20200301-Git三路合并.md)
- [Git合并分支](2020/20200301-Git合并分支.md)
- [Git的Revert说明](2024/20240614-Git的Revert说明.md)
- [Git版本回退](2022/20220414-Git版本回退.md)
...
- [Hadoop面试题](2022/20220709-Hadoop面试题.md)
...
- [Hibernate事务管理](2019/20190707-Hibernate事务管理.md)
...
- [Istio_服务的可观察性](2022/20220811-Istio_服务的可观察性.md)
- [Istio_安全](2022/20220811-Istio_安全.md)
- [Istio_虚拟服务和目标规则](2022/20220810-Istio_虚拟服务和目标规则.md)
- [Istio_网关](2022/20220810-Istio_网关.md)
- [Istio_服务入口](2022/20220810-Istio_服务入口.md)
...
- [Java中的容器](2017/20170811-Java中的容器.md)
  - [解决hash冲突的办法有哪些_HashMap用的哪种](2022/20220304-解决hash冲突的办法有哪些_HashMap用的哪种.md)
  - [一般用什么作为HashMap的key](2022/20220314-一般用什么作为HashMap的key.md)
  - [HashMap为什么线程不安全](2022/20220314-HashMap为什么线程不安全.md)
  - [Hashtable的锁机制](2022/20220314-Hashtable的锁机制.md)
  - [多线程下安全的操作map的其他方法](2022/20220314-多线程下安全的操作map的其他方法.md)
- [Java容器线程不安全该如何处理](2017/20170811-Java容器线程不安全该如何处理.md)
- [Java多线程中锁的八种情况](2017/20170812-Java多线程中锁的八种情况.md)
- [Java中的Lambda表达式](2018/20180409-Java中的Lambda表达式.md)
...
- [java传值还是传址](2023/20230411-java传值还是传址.md)
...
- [hs_err_pid文件分析](2024/20241029-hs_err_pid文件分析.md)
- [Java字节码解析](2025/20250225-Java字节码解析.md)
- [Java创建时间的方法归纳](2025/20251114-Java创建时间的方法归纳.md)

### JavaSE安全编码指北

- [JavaSE安全编码_01_基础知识](2025/20250425-JavaSE安全编码_01_基础知识.md)
- [JavaSE安全编码_02_拒绝服务](2025/20250425-JavaSE安全编码_02_拒绝服务)

### Java内存

- [jstat命令详解](2025/20250313-jstat命令详解.md)
- [VisualVM使用](2024/20240930-VisualVM使用.md)
- [分析内存工具](2025/20250320-分析内存工具.md)
- [JAVA服务内存占用太高且只增不减](2024/20240930-JAVA服务内存占用太高且只增不减.md)
- [容器环境的JVM内存设置最佳实践](2024/20241011-容器环境的JVM内存设置最佳实践.md)
- [Java进程内存问题排查](2023/20231108-Java进程内存问题排查.md)
...
- 原理篇
  ...
  - [Java多线程原理篇_03_volatitle](2021/20210917-volatitle.md)
    - [理解Java中的volatile关键字](2017/20170812-理解Java中的volatile关键字.md)
  - [Java多线程原理篇_04_synchronized与锁](2021/20210917-synchronized与锁.md)
    - [Java偏向锁](2022/20220126-Java偏向锁.md)
  - [Java多线程原理篇_05_CAS与原子操作](2022/20220209-CAS与原子操作.md)
    - [CAS底层原理](2017/20170818-CAS底层原理.md)
...
- JDK工具篇
  - [Java多线程JDK工具篇_01_线程池原理](2021/20210922-线程池原理.md)
    - [Java线程池异常处理方案](2024/20240315-Java线程池异常处理方案.md)
  ...
  - [Java多线程JDK工具篇_04_并发容器集合](2022/20220209-并发容器集合.md)
    - [ConcurrentHashMap说明](2022/20220314-ConcurrentHashMap说明.md)
    - [迭代器遍历集合对象时的快速失败和安全失败](2022/20220314-迭代器遍历集合对象时的快速失败和安全失败.md)
  ...
  - [Java多线程JDK工具篇_09_计划任务](2022/20220209-计划任务.md)
- 应用篇
  - [线程池的常规写法](2026/20260109-线程池的常规写法.md)
...
- [JNI基础与实践](2023/20231229-JNI基础与实践.md)
- [JNI内存管理](2024/20240703-JNI内存管理.md)
- [JNI调用时的内存管理](2025/20250211-JNI调用时的内存管理.md)
...
- [JVM从入门到精通-04-程序计数器](2018/20180821-JVM从入门到精通-04-程序计数器.md)
- [JVM从入门到精通-05-虚拟机栈](2018/20180821-JVM从入门到精通-05-虚拟机栈.md)
  - [StackMapTable说明（栈映射帧说明）](2026/20260918-stackMapTable说明.md)
- [JVM从入门到精通-06-本地方法接口](2018/20180825-JVM从入门到精通-06-本地方法接口.md)
- [JVM从入门到精通-07-本地方法栈](2018/20180825-JVM从入门到精通-07-本地方法栈.md)
- [JVM从入门到精通-08-堆](2018/20180825-JVM从入门到精通-08-堆.md)
- [JVM从入门到精通-09-方法区](2018/20180827-JVM从入门到精通-09-方法区.md)
- [JVM从入门到精通-10-对象实例化内存布局与访问定位](2018/20180829-JVM从入门到精通-10-对象实例化内存布局与访问定位.md)
- [JVM从入门到精通-11-直接内存](2018/20180901-JVM从入门到精通-11-直接内存.md)
- [JVM从入门到精通-12-执行引擎](2018/20180901-JVM从入门到精通-12-执行引擎.md)
- [JVM从入门到精通-13-StringTable](2018/20180901-JVM从入门到精通-13-StringTable.md)
- [JVM从入门到精通-14-垃圾回收概述](2018/20180902-JVM从入门到精通-14-垃圾回收概述.md)
- [JVM从入门到精通-15-垃圾回收相关算法](2018/20180902-JVM从入门到精通-15-垃圾回收相关算法.md)
...
- [精度丢失问题](2021/20210923-精度丢失问题.md)
...
- [maven的常用命令和生命周期](2019/20190730-maven的常用命令和生命周期.md)
- [maven的目录结构规范](2019/20190730-maven的目录结构规范.md)
...
- [MySQL创建用户与授权](2023/20230412-MySQL创建用户与授权.md)
- [MySQL事务](2022/20220314-MySQL事务.md)
- [MySQL锁](2022/20220314-MySQL锁.md)
- [MySQL索引](2022/20220314-MySQL索引.md)
  - [MySQL全文索引](2021/20210918-MySQL全文索引.md)
...
- [PDF内置对象](2022/20221117-PDF内置对象.md)
...
- [Redis_如何保证数据库和缓存的数据一致性](2022/20220314-Redis_如何保证数据库和缓存的数据一致性.md)
...
- [aws-cli使用日志](2026/20260108-aws-cli使用日志.md)
- [obsutil使用日志](2026/20260118-obsutil使用日志.md)
...
- Spring
  ...
  - [SpringMVC的简单的参数绑定](2017/20171007-SpringMVC的简单的参数绑定.md)
  - [SpringMVC的pojo参数绑定](2017/20171022-SpringMVC的pojo参数绑定.md)
  - [SpringMVC的数组参数绑定](2017/20171023-SpringMVC的数组参数绑定.md)
  - [SpringMVC的List参数绑定](2017/20171024-SpringMVC的List参数绑定.md)
  - [SpringMVC的自定义参数绑定](2017/20171030-SpringMVC的自定义参数绑定.md)
  - [SpringMVC的-RequestMapping注解的作用](2017/20171112-SpringMVC的-RequestMapping注解的作用.md)
  - [Spring的IOC和DI](2019/20190713-Spring的IOC和DI.md)
  - [Spring如何下载包](2019/20190713-Spring如何下载包.md)
  - [Spring的分模块开发的配置](2019/20190714-Spring的分模块开发的配置.md)
  - [Spring的工厂类](2019/20190714-Spring的工厂类.md)
  - [Spring的属性注入](2019/20190714-Spring的属性注入.md)
  - [Spring的AOP的XML开发](2019/20190715-Spring的AOP的XML开发.md)
  - [Spring的IOC注解开发](2019/20190715-Spring的IOC注解开发.md)
  - [Spring的代理模式](2019/20190715-Spring的代理模式.md)
  - [Spring的AOP的基本使用案例](2019/20190720-Spring的AOP的基本使用案例.md)
  - [Spring的aop根据参数名称获取参数的值](2019/20190721-Spring的aop根据参数名称获取参数的值.md)
  - [Spring的JDBC的模板的使用](2019/20190721-Spring的JDBC的模板的使用.md)
  - [Spring的切点表达式写法](2019/20190721-Spring的切点表达式写法.md)
  - [Spring的通知类型](2019/20190721-Spring的通知类型.md)
...
- 设计原则
  ...
  - [接口分离原则](2021/20210720-接口分离原则.md)
  - [迪米特原则](2021/20210720-迪米特原则.md)
  - [依赖倒置原则](2021/20210720-依赖倒置原则.md)
  - [合成复用原则](2025/20250428-合成复用原则.md)
- 创建型模式
...
- 结构型模式
  ...
  - [设计模式之过滤器模式](2025/20250429-设计模式之过滤器模式.md)
  - [设计模式之组合模式](2025/20250429-设计模式之组合模式.md)
  - [设计模式之外观模式](2018/20180226-设计模式之外观模式.md)
  - [设计模式之装饰器模式](2018/20180226-设计模式之装饰器模式.md)
  - [设计模式之享元模式](2025/20250428-设计模式之享元模式.md)
- 行为型模式
  - [设计模式之策略模式](2022/20220228-设计模式之策略模式.md)
- 区别与联系
  - [命令模式_策略模式_状态模式的区别](2022/20220609-命令模式_策略模式_状态模式的区别.md)
...
- [Java中实现链表之双向链表](2020/20200331-Java中实现链表之双向链表.md)
- [Java中实现链表之用环形链表解决约瑟夫问题](2020/20200401-Java中实现链表之用环形链表解决约瑟夫问题.md)
- [Java中实现栈](2020/20200402-Java中实现栈.md)
- [Java中栈的「前缀」「中缀」「后缀」表达式](2020/20200402-Java中栈的「前缀」「中缀」「后缀」表达式.md)
- [Java中实现递归](2020/20200414-Java中实现递归.md)
- [尾递归](2020/20200414-尾递归.md)
- [排序算法的与分类](2020/20200415-排序算法的与分类.md)
- [Java中实现冒泡排序](2020/20200416-Java中实现冒泡排序.md)
- [Java中实现插入排序](2020/20200420-Java中实现插入排序.md)
- [Java中实现希尔排序_插入排序的改良版](2020/20200420-Java中实现希尔排序_插入排序的改良版.md)
- [Java中实现选择排序](2020/20200420-Java中实现选择排序.md)
- [Java中实现快速排序](2020/20200422-Java中实现快速排序.md)
- [Java中实现归并排序](2020/20200424-Java中实现归并排序.md)
- [Java中实现基数排序](2020/20200424-Java中实现基数排序.md)
- [Java中实现哈希表](2020/20200426-Java中实现哈希表.md)
- [二叉树的相关概念及在Java中实现二叉树的遍历查找和删除](2020/20200427-二叉树的相关概念及在Java中实现二叉树的遍历查找和删除.md)
- [堆（二叉堆）](2020/20200502-堆的基本介绍与堆排序的Java实现.md)
- [Java中实现顺序存储二叉树](2020/20200502-Java中实现顺序存储二叉树.md)
- [Java中实现线索化二叉树与线索化二叉树的遍历](2020/20200502-Java中实现线索化二叉树与线索化二叉树的遍历.md)
- [赫夫曼树_最优二叉树与赫夫曼树的JAVA实现](2020/20200503-赫夫曼树_最优二叉树与赫夫曼树的JAVA实现.md)
- [赫夫曼编码](2020/20200504-赫夫曼编码.md)
- [二叉排序树的基本介绍与Java实现](2020/20200505-二叉排序树的基本介绍与Java实现.md)
- [平衡二叉搜索树之AVL树](2020/20200505-平衡二叉搜索树之AVL树.md)
- [平衡二叉搜索树之红黑树](2020/20200505-平衡二叉搜索树之红黑树.md)
- [多路查找树](2020/20200506-多路查找树.md)
- [图的基本介绍与深度和广度优先遍历算法](2020/20200507-图的基本介绍与深度和广度优先遍历算法.md)
- [动态规划算法--背包问题](2020/20200508-动态规划算法--背包问题.md)
- [二分查找算法-非递归](2020/20200508-二分查找算法-非递归.md)
- [分治算法--汉诺塔问题](2020/20200508-分治算法--汉诺塔问题.md)
- [克鲁斯卡尔算法-公交站问题-最小生成树](2020/20200508-克鲁斯卡尔算法-公交站问题-最小生成树.md)
- [普里姆算法-修路问题--最小生成树](2020/20200508-普里姆算法-修路问题--最小生成树.md)
- [贪心算法--集合覆盖问题](2020/20200508-贪心算法--集合覆盖问题.md)
- [KMP算法--字符串查找算法](2020/20200508-KMP算法--字符串查找算法.md)
- [迪克斯特拉算法Dijkstra-最短路径问题](2020/20200509-迪克斯特拉算法Dijkstra-最短路径问题.md)
...
- [一致性哈希算法原理详解](2024/20241029-一致性哈希算法原理详解.md)
- [时间轮算法](2025/20250721-时间轮算法.md)
...
- [项目遇到的问题之Spark](2020/20200829-项目遇到的问题之Spark.md)
...
- [Ubuntu安装剪切板管理工具copyq](2019/20190704-Ubuntu安装剪切板管理工具copyq.md)
- [Ubuntu安装文本工具notepadqq](2019/20190704-Ubuntu安装文本工具notepadqq.md)
- [Ubuntu安装截屏工具](2019/20190707-Ubuntu安装截屏工具.md)
- [ubuntu中安装fzf](2019/20190729-ubuntu中安装fzf.md)
- [ubuntu中安装iptux](2019/20190818-ubuntu中安装iptux.md)
- [ubuntu中安装openshot-video-editor](2019/20190818-ubuntu中安装openshot-video-editor.md)
- [ubuntu中安装桌面维基zim](2019/20190818-ubuntu中安装桌面维基zim.md)
- [Ubuntu中wps2019可以插入公式](2019/20190912-Ubuntu中wps2019可以插入公式.md)
- [Ubuntu中wps英文版如何改为中文版](2020/20200528-Ubuntu中wps英文版如何改为中文版.md)
- [Ubuntu中KeePass无法自动输入](2020/20200324-Ubuntu中KeePass无法自动输入.md)
- [Ubuntu中安装防火墙管理的图形界面Gufw](2020/20200325-Ubuntu中安装防火墙管理的图形界面Gufw.md)
- [Ubuntu中安装全局搜索软件Synapse](2020/20200325-Ubuntu中安装全局搜索软件Synapse.md)
- [Ubuntu中安装kchmviewer用以打开chm文件](2020/20200409-Ubuntu中安装kchmviewer用以打开chm文件.md)
- [Ubuntu中安装流程图工具Dia](2020/20200429-Ubuntu中安装流程图工具Dia.md)
- [Ubuntu中安装词典GoldenDict](2020/20200614-Ubuntu中安装词典GoldenDict.md)
- [Ubuntu中安装Ganglia](2020/20200604-Ubuntu中安装Ganglia.md)
- [Ubuntu上安装OCR扫描软件gImageReader](2021/20211010-Ubuntu上安装OCR扫描软件gImageReader.md)
- [Ubuntu中一键OCR识别图片截图文字转文本](2020/20200614-Ubuntu中一键OCR识别图片截图文字转文本.md)
- [Ubuntu中安装离线API文档大全Zeal](2020/20200707-Ubuntu中安装离线API文档大全Zeal.md)
- [Ubuntu中安装桌面搜索应用DocFetcher](2020/20200707-Ubuntu中安装桌面搜索应用DocFetcher.md)
- [Ubuntu中安装分区管理工具gparted](2020/20200708-Ubuntu中安装分区管理工具gparted.md)
- [Ubuntu中基于Docker安装QQ和WeChat](2020/20200708-Ubuntu中基于Docker安装QQ和WeChat.md)
...
- [Ubuntu批量修改目录与文件权限](2018/20180916-Ubuntu批量修改目录与文件权限.md)
- [Ubuntu中控制鼠标滚动速度](2018/20180916-Ubuntu中控制鼠标滚动速度.md)
- [Ubuntu中添加用户到指定组](2019/20190625-Ubuntu中添加用户到指定组.md)
- [Ubuntu中点击外部应用的链接后跳转到Chrome却无法打开应用的问题](2020/20200227-Ubuntu中点击外部应用的链接后跳转到Chrome却无法打开应用的问题.md)
- [Ubuntu修改时区](2020/20200321-Ubuntu修改时区.md)
- [Ubuntu开启smb协议与手机互联](2020/20200529-Ubuntu开启smb协议与手机互联.md)
- [Ubuntu中安装和删除字体](2020/20200604-Ubuntu中安装和删除字体.md)
- [Ubuntu18-04如何固定图标到任务栏](2020/20200718-Ubuntu18-04如何固定图标到任务栏.md)
- [Ubuntu设置开机自动加-挂载硬盘](2020/20200724-Ubuntu设置开机自动加-挂载硬盘.md)
...
- [微服务改造](2023/20230816-微服务改造.md)
- [DDD之架构模型](2026/20260112-DDD之架构模型.md)
- [DDD之贫血和充血模式](2026/20260112-DDD之贫血和充血模式.md)
- [DDD之架构落地](2026/20260113-DDD之架构落地.md)
- [CQRS_命令查询责任分离](2026/20260113-CQRS_命令查询责任分离.md)

## Vim

- [Vim_配置文件](2017/20170102-vim配置文件.md)
- [Vim_的全局替换](2017/20170214-vim的全局替换.md)
- [Vim_全局搜索文件](2017/20170410-Vim全局搜索文件.md)
- [Vim_全局命令](2017/20170531-vim全局命令.md)
- [Vim_中显示markdown结构大纲](2019/20190729-vim中显示markdown结构大纲.md)
- [Vim_中删除句尾的空白字符](2019/20190730-vim中删除句尾的空白字符.md)
- [Vim_与系统剪贴板的复制粘贴](2024/20240902-VIM与系统剪贴板的复制粘贴.md)
- [Vim_如何暂时返回终端](2024/20241022-vim暂时返回终端.md)
...
- [深入浅出SAML协议](2024/20240311-深入浅出SAML协议.md)
- [CAS详细认证流程](2024/20240312-CAS详细认证流程.md)

## 信息项目管理

- [信息项目管理_十大管理](2026/20260127-信息项目管理_十大管理.md)
- [信息项目管理_整合管理](2026/20260128-信息项目管理_整合管理.md)
...
- [14次架构升级_淘宝是如何从单机到支持千万级别并发](2022/20220315-14次架构升级_淘宝是如何从单机到支持千万级别并发.md)
- [高并发之限流](2022/20220613-高并发之限流.md)
- [数字签名说明](2023/20230213-数字签名说明.md)
- [word快速统一设置中文和英文字体](2024/20240709-word快速统一设置中文和英文字体.md)
- [Linux常用命令](2025/20250325-Linux常用命令.md)
- [理解响应式编程](2025/20251208-理解响应式编程.md)