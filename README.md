...
-   [Hadoop => 跳转到本文档中对应位置](README?id=Hadoop)
-   [Kafka => 跳转到本文档中对应位置](README?id=Kafka)
-   [Scala => 跳转到本文档中对应位置](README?id=Scala)
-   [Spark => 跳转到本文档中对应位置](README?id=Spark)
-   [Sqoop => 跳转到本文档中对应位置](README?id=Sqoop)
...
-   [Ubuntu安装截屏工具Shutter](2019/20190707-Ubuntu安装截屏工具Shutter.md)
