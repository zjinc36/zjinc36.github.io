...
?>  一句话总结:回调 => 用以确认消息是否成功发送到交换机

确认机制方案：

![](../images/2021/11/20211124090551.png)

代码架构图：

![](../images/2021/11/20211124090603.png)
...
```java
import com.atguigu.springbootrabbitmq.service.MyCallBack;
import lombok.extern.slf4j.Slf4j;
import org.springframework.amqp.rabbit.connection.CorrelationData;
import org.springframework.amqp.rabbit.core.RabbitTemplate;
...
![](../images/2021/11/20211124090849.png)
...
?>  一句话总结:回调 => 当消息成功到交换机但无法路由到队列时进行回调通知
...
+   使用 RabbitTemplate.ReturnsCallback
...
+   使用 RabbitTemplate.ReturnCallback
...
![](../images/2021/11/20211124094941.png)


#   备份交换机

?>  一句话总结:发送到备份交换机 => 当消息成功到主交换机但无法路由到队列时(不单单进行回调通知),将消息转发到备份交换机,由备份交换机进行处理

?>  一句话总结:"发送到备份交换机"的优先级大于"无法路由回调"
...
![](../images/2021/11/20211124095656.png)
...
![](../images/2021/11/20211124095740.png)

访问： http://localhost:8080/confirm/sendMessage/你好

![](../images/2021/11/20211124095755.png)
