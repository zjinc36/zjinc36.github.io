...
+   [slf4j（simple-logging-facade-for-java）日志标准接口规范](/2022/20220103-Java日志体系的发展史?id=slf4j（simple-logging-facade-for-java）日志标准接口规范)
...
[logback日志标准库](/2022/20220103-Java日志体系的发展史?id=logback日志标准库)
