...
来源:[真香！自动同步ios的提醒事项和日历，显示日打卡内容](https://zhuanlan.zhihu.com/p/169566930)

1.  下载`Scriptable`软件

2.  在Scriptable中创建如下脚本,脚本命名为`待办事项同步到日历`
...
3.  在iphone创建`快捷指令`
    +   打开"提醒事项"调用上述Scriptable软件的脚本
    +   打开"日历"调用上述Scriptable软件的脚本